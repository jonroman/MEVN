<template>
  <div id="MainView" v-if="show_main_view">
    <div id="large-view" v-if="$mq === 'lg'"> <!-- VIEW: Main Large -->
      <div class="row no-gutters">
       ...
       <div class="col-4">
         <div class="search-bar-large animated bounceIn">
           <div class="search-bar-middle">
             <SearchBar />
           </div>
         </div>
         <div class="quick-links quick-links-large animated zoomIn">
     ...
     <div class="row no-gutters">
       <div class="col-3">
         <div class="event-log event-log-large animated slideInLeft">
           <div class="event-log-middle ribbon">
             <h3>Event Log</h3> col-lg-3
           </div>
         </div>
         <div class="employee-slider employee-slider-large animated slideInLeft">
       ...
       <div class="col-5">
         <div class="recent-log recent-log-large animated slideInUp">
       ...
       <div class="col-4">
         <div class="im im-large animated bounceInUp">
    ...
    <div id="large-view" v-if="$mq === 'md'"> <!-- VIEW: Main Large -->
      ...
      <div class="row no-gutters">
        <div class="col-8">
          <div class="recent-log recent-log-medium animated slideInLeft">
            <div class="recent-log-middle recent-log-middle-medium ribbon">
              <h3>Recent Log</h3> col-lg-5
            </div>
          </div>
          <div class="event-log event-log-medium animated bounceInUp">
        ...
        <div class="col-4">
          <div class="search-bar-medium animated bounceIn">
            <div class="search-bar-middle search-bar-middle-medium ribbon">
             <SearchBar />>
            </div>
          </div>
          <div class="im im-medium animated bounceIn">
            <div class="im-middle im-middle-medium ribbon">
              <h3>Instant Message</h3> col-lg-4
            </div>
          </div>
          <div class="employee-slider employee-slider-medium animated bounceInUp">
    ...
    <div id="large-view" v-if="$mq === 'sm'"> <!-- VIEW: Main Large -->
      ...
      <div class="row no-gutters">
        <div class="col-12">
          <div class="recent-log recent-log-small animated bounceInLeft">
      ...
      <div class="row no-gutters">
        <div class="col-12">
          <div class="employee-slider employee-slider-small animated bounceIn">
      ...
      <div class="row no-gutters">
        <div class="col-12">
          <div class="event-log event-log-small animated bounceIn">
